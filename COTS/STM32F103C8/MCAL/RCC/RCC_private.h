 ...
 * for configuring and controlling system clocks and resets in the micro-controller.
 *
 * @{
 */
 ...
 *
 * This register configures the system clock sources, Pre-scalers, and peripherals clocks.
 */
